...
HD_PWD='C:/Dev/TAUV-Acoustics/hdl/acoustics-v2-zybo/acoustics-v2-zybo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AGC_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AGC_wrapper.tcl
