...
if { $run_remote_bd_flow == 1 } {
  ...
  set origin_dir ./hdl/platforms/myc-y7z020v2
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [list \
    ...
    CONFIG.PCW_MIO_TREE_PERIPHERALS {GPIO#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#USB Reset#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#Enet 0#Enet 0#Enet\
...
\
    ...
    CONFIG.PCW_PACKAGE_DDR_BOARD_DELAY0 {0.346} \
    CONFIG.PCW_PACKAGE_DDR_BOARD_DELAY1 {0.321} \
    CONFIG.PCW_PACKAGE_DDR_BOARD_DELAY2 {0.303} \
    CONFIG.PCW_PACKAGE_DDR_BOARD_DELAY3 {0.296} \
    CONFIG.PCW_PACKAGE_DDR_DQS_TO_CLK_DELAY_0 {0.203} \
    CONFIG.PCW_PACKAGE_DDR_DQS_TO_CLK_DELAY_1 {0.262} \
    CONFIG.PCW_PACKAGE_DDR_DQS_TO_CLK_DELAY_2 {0.118} \
    CONFIG.PCW_PACKAGE_DDR_DQS_TO_CLK_DELAY_3 {0.122} \
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK]
